...
record_name=$2
process=$3
uplink_trace=/data4/pantea/nets_scripts/traces/paper_ours_shrink
...
#mm-delay 25 mm-link --uplink-log=${record_name}/mahimahi.log --uplink-queue=droptail --uplink-queue-args=bytes=10000 $uplink_trace $downlink_trace ./offer_ours.sh  ${video_name} ${record_name} &
