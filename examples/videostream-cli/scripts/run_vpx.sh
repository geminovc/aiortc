...
record_name=$2
process=$3
uplink_trace=/data4/pantea/nets_scripts/traces/paper_ours
...
mm-graph ${experiment_dir}/${record_name}/mahimahi.log 100 --no-port --yrange \"0:2\" --no-display \
		--plot-direction egress > ${experiment_dir}/${record_name}/mahimahi.eps 2> ${experiment_dir}/${record_name}/mmgraph.log
